...
class WindowBasedModel_GUROBI:
    def __init__(self, graph, duty_categories, duties_require_break, duty_original_starttimes, duty_original_endtimes, time_window, suitable_tasks):
        ...
        self.env.setParam("WLSAccessID", "5d7a35f3-7b2e-477d-902c-1e16aae432ba")
        self.env.setParam("WLSSecret", "067968bb-f8df-4faa-8fcb-6b5813574d90")
        self.env.setParam("LicenseID", 2790310)
